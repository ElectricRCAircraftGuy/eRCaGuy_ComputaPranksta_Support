...
1. When done choosing the modes you like, press `Scroll Lock` 5 times again to save the settings to the device's internal memory and exit programming mode. Note: the Notepad text editor will remain open. Your new modes will now be in effect. 
